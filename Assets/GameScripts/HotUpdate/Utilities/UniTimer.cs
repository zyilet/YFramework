namespace GameScripts.HotUpdate.Utilities
{
    public sealed class UniTimer
    {
        ...
        public static UniTimer CreateRepeatTimer(float delay, float interval)
        {
        ...
        public static UniTimer CreateRepeatTimer(float delay, float interval, float duration)
        {
        ...
        public static UniTimer CreateRepeatTimer(float delay, float interval, long maxTriggerCount)
        {
